...
namespace i5.Toolkit.ModelImporters
{
    ...
    public class ObjImporter2 : IUpdateableService
    {
        ...
        private IEnumerator Get(string url, Action<UnityWebRequest> callback)
        {
        ...
        public async void Update()
        {
            if (Input.GetKeyDown(KeyCode.Space))
            {
                ...
                await ImportAsync("https://raw.githubusercontent.com/rwth-acis/Unity-Toolkit/features/objImporter/Assets/Examples/Importers/ObjImporter/Obj%20Models/Monkey_quads.obj");
