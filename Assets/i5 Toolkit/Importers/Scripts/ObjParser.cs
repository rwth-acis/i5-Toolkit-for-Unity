...
{
    public class ObjParser : AsyncThreadedWorkerService<ParseOperation>
    {
        public bool ExtendedLogging { get; set; } = false;

        protected override void AsyncOperation(ParseOperation operation)
        {
    ...
    public class ParseOperation : Operation<GeometryConstructor>
    {
        public string[] contentLines;

        public ParseOperation(string[] contentLines, Action<Operation<GeometryConstructor>> callback) : base(callback)
        {
